...
#define CMD_MELEE       0x80 // Bit 7 - 백병전 돌입  1000 0000
...
void showStatus(unsigned char fleet) {
    ...
    if (fleet & CMD_MELEE)       printf("백병전 돌입!\n");
    if (fleet == 0)              printf("모든 함선 대기 상태\n");
}

void printMenu(void) {
    printf("\n=== 이순신의 한산 전쟁! ===\n");
    printf("1. Toggle 장전준비\n");
